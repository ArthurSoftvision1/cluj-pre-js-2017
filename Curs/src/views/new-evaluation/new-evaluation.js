interviewApp.NewEvaluationPage = function(optionss = {}) {
    ...
    const legendSelectorContent =['0', '1', '2', '3']
        ...
        const technicalLevelContent = {
         ...
         const detailsForm = [
             ...
             `<a href="evaluation.html"> <img class="calendar-date" src="src/views/img/2019-200.png"></a>`
            ]
    ...
    return `
        ${interviewApp.NAV(options.navigationLinks)},
        ...
        ${interviewApp.Footer(options.footerAreaSection)},
        `;
}
